...
`Power BI` `DuckDB` `dbt` `Python` `SQL` `Business Intelligence`
...
| Git / GitHub  | Versioning et portfolio      |
...
* secteurs les plus générateurs de chiffre d’affaires.
...
[https://data.economie.gouv.fr/explore/dataset/ratios_inpi_bce/](https://data.economie.gouv.fr/explore/dataset/ratios_inpi_bce/)
...
**Ingénieur informatique | Data Analyst / BI**
...
[https://github.com/Djaha-Charly](https://github.com/Djaha-Charly)
